...
public class HomeWork12 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(c);
        c = (5 + 7 > 20 ? 68 : 22 * 2 >> b++) / --a; //результат: 0, не очень понимаю почему именно, единственным объяснением вижу изменение поведения постфиксального инкремента из-за обилия операций, которые идут после него, и в операции побитового сдвига используется 3, а не 2; по порядку первыми идут инкремент и декремент, затем умножение, сложение и побитовый сдвиг, после идет сравнение результата сложения с условием тернарного оператора, последним идет деление варианта выбранного тернарным оператором на 7
        System.out.println(c);
